<template>
  <div class="page-container" @scroll="onPageScroll">
    <div class="section full-page light" id="section-1">
      <div class="project-title">Daily Idiom</div>
      <div class="vertial-bottom-left-text">June, 2020</div>
    </div>
    <div class="section light" id="section-2">
      <div class="large-text">Daily Idiom</div>
      <div class="large-text">Idiom Daily</div>
      <div class="center-title">Digital Learning</div>
      <div class="vertial-bottom-left-text">Course Project</div>
    </div>
    ...
    <div class="section full-page dark" id="section-6">
      ...
      <div class="vertial-bottom-left-text">Scheme - Clerk - System</div>
      <CircularText
        id="circular-text"
